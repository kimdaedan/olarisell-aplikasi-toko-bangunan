...
<body class="bg-gray-100 flex items-center justify-center h-screen">
    ...
    <div class="w-full max-w-md">
        <div class="text-center mb-8">
            <img src="{{ asset('logo.png') }}" alt="Logo OLARISELL" class="w-48 mx-auto">
            <h2 class="mt-6 text-2xl font-bold text-gray-700">Selamat Datang Kembali!</h2>
            <p class="text-gray-500">Silakan login untuk melanjutkan.</p>
        </div>

        <form action="{{ route('login.submit') }}" method="POST" class="bg-white p-8 rounded-lg shadow-lg space-y-6">
            @csrf
